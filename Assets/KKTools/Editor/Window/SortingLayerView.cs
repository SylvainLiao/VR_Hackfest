...
public class SortingLayerView : EditorWindow
{
    #region Main Data
   ...
   public static void ShowWindow()
    {
        ...
        EditorWindow window = EditorWindow.GetWindow(typeof(SortingLayerView), false, "Sorting View", true);
