/**********************************************************
// Author   : K.(k79k06k02k)
// FileName : ScreenshotTaker.cs
// Reference: https://www.assetstore.unity3d.com/en/content/24122
**********************************************************/
using UnityEditor;
using UnityEngine;
...
public class ScreenshotTaker : EditorWindow
{
    ...
    public static void ShowWindow()
    {
        ...
        editorWindow.position = new Rect(editorWindow.position.xMin + 100f, editorWindow.position.yMin + 100f, 600, 700);
        editorWindow.autoRepaintOnSceneChange = true;
        editorWindow.Show();
        editorWindow.titleContent = new GUIContent("Screen Shot");
    }
